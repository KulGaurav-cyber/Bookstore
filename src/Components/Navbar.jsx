...
function Navbar() {
  ...
  return (
    <div>
        <div className={`max-w-screen-2x1 container mx-auto md:px-3 dark:bg-slate-800 dark:text-white fixed top-0 fixed left-0 fixed right-0 ${
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-7 z-[1] p-2 shadow  mx-auto rounded-box w-52">
      {navItem}  
      </ul>
    </div>
